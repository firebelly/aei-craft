...
namespace modules\deltekimportmodule\migrations;
...
/**
 * Deltek Import Install Migration
 *
...
class Install extends Migration
{
    ...
    // deltekimportmodule_deltekimportmodulerecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%deltekimportmodule_deltekimportmodulerecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%deltekimportmodule_deltekimportmodulerecord}}',
                [
                    'id' => $this->primaryKey(),
    ...
    // deltekimportmodule_deltekimportmodulerecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%deltekimportmodule_deltekimportmodulerecord}}', 'siteId'),
            '{{%deltekimportmodule_deltekimportmodulerecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // deltekimportmodule_deltekimportmodulerecord table
        $this->dropTableIfExists('{{%deltekimportmodule_deltekimportmodulerecord}}');
    }
}
