...
namespace firebelly\aei\widgets;

use firebelly\aei\AEI;
use firebelly\aei\assetbundles\deltekimportwidget\DeltekImportWidgetAsset;
 ...
 * @since     1.0.0
 */
class DeltekImport extends Widget
{
    ...
    {
        return Craft::t('aei', 'DeltekImport');
    }
    ...
    {
        return Craft::getAlias("@firebelly/aei/assetbundles/deltekimportwidget/dist/img/DeltekImport-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'aei/_components/widgets/DeltekImport_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(DeltekImportWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'aei/_components/widgets/DeltekImport_body',
            [
